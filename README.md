...
[![CodeFactor](https://www.codefactor.io/repository/github/Lombeira/next-chakra-ts/badge)](https://www.codefactor.io/repository/github/Lombeira/next-chakra-ts)
...
```bash
npx degit Lombeira/next-chakra-ts <YOUR_APP_NAME>
```
